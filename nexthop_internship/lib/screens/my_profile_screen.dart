  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          body: Padding(
        padding:
            EdgeInsets.only(top: 15.0, left: 25.0, right: 25.0, bottom: 80.0),
        child: Column(
          ...
          children: [
            ...
            ExpandableCard(
              cardTitle: 'John Doe',
              cardIcon:
                  Icon(Icons.person_outline, color: kBlueAppColor, size: 60.0),
            ...
            ExpandableCard(
              cardTitle: 'Family',
              cardIcon:
                  Icon(Icons.people_outline, color: kBlueAppColor, size: 60.0),
              expandableCardChild: ExpandableCardChild(
